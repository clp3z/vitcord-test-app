...
public class CustomToggleButton
    ...
    public void parseAttributes(Context context, AttributeSet attributes) {
        TypedArray typedArray = context.obtainStyledAttributes(attributes, R.styleable.CustomToggleButton);

        String textViewTypeface = typedArray.getString(R.styleable.CustomToggleButton_typeface);
