...
public class CustomRadioButton
    ...
    public void parseAttributes(Context context, AttributeSet attributes) {
        TypedArray typedArray = context.obtainStyledAttributes(attributes, R.styleable.CustomRadioButton);

        String textViewTypeface = typedArray.getString(R.styleable.CustomRadioButton_typeface);
