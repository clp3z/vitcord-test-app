...
public abstract class LifecycleLoggingFragment
    ...
    public void onStart() {
        super.onStart();
        logger.log("onStart", "The activity is visible but no ready for user interaction");
    }
    ...
    public void onResume() {
        super.onResume();
        logger.log("onResume", "The activity it's visible and ready for user interaction");
    }
    ...
    public void onDestroyView() {
        logger.log("onDestroyView", "The view has been removed from the activity and about to be destroyed");
        super.onDestroyView();
    }
    ...
    public void onDestroy() {
        logger.log("onDestroy", "The fragment is no longer in use and is about to be destroyed");
        super.onDestroy();
    }
